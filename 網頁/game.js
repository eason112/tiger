...
background1.src = '/網頁/images/middle.png';  // 第一層背景

const background2 = new Image();
background2.src = '/網頁/images/front.png';  // 第二層背景

const background3 = new Image();
background3.src = '/網頁/images/back.png';  // 第三層背景

const playerImage = new Image();
playerImage.src = '/網頁/images/player.png';

const npcImage = new Image();
npcImage.src = '/網頁/images/NPC.png';

const petImage = new Image();
petImage.src = '/網頁/images/NPC.png';

const minimapImage = new Image();
minimapImage.src = '/網頁/images/minimap.png';  // 替換成你的圖像路徑
